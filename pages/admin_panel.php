                    ...
                    <div class="tab-content gallery">
                        <div class="tab-pane active" id="products" role="tabpanel">
                            <div class="col-md-12 ml-auto mr-auto">
                                          ...
                                          if($result){
                                            while($res = mysqli_fetch_array($result)) {     
                                              echo "<tr>";
                                                ...
                                                echo "<td> | <a href=\"product_delete.php?prod_id=$res[prod_id]
                                ...
                                <br><br>
                                <a class="btn btn-success btn-round" href="product_add.php"><i class="now-ui-icons ui-1_simple-add"></i> Add Updates</a>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="col-md-12 ml-auto mr-auto">
                                <div class="row collections">
                                    ...
                                    <br>                
                                      ...
                                      $action = isset($_GET['action']) ? $_GET['action'] : "";
                                      if($action=='deleted'){
                                          echo "<div class='alert alert-success'>updates was deleted.</div>";
                                      }
                                ...
                                <br><br>
                                <a class="btn btn-success btn-round" href="admin_signup.php"><i class="now-ui-icons ui-1_simple-add"></i> Add Admin</a>
                                </div>
                            </div>
                        </div>
                    </div>
