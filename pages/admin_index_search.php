            ...
            <div class="section section-basic">
                <div class="container">
                    ...
                    <div class="col-md-12">
                        ...
                        <center>
                        <label><b>Search Updates: &nbsp</b></label>       
                        ...
                        <ul class="thumbnails">
                            ...
                            <div class="row-sm-3">
                                <div class="thumbnail">
                                    ...
                                    <?php else: ?>
                                    <img src="../uploads/default.png" width="300px" height="300px">
                                    <?php endif; ?>
                                <div class="caption">
                                  <h5><b><?php echo $res['prod_name'];?></b></h5>
                                  <h6><a class="btn btn-success btn-round" title="Click for more details!" href="admin_product_details.php?prod_id=<?php echo $res['prod_id'];?>"><i class="now-ui-icons gestures_tap-01"></i>View</a><medium class="pull-right"></medium></h6>
                                </div>
