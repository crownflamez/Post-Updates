                ...
                <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
                    ...
                    <div class="carousel-inner" role="listbox">
                        <div class="carousel-item active">
                            ...
                            <img class="d-block" src="../uploads/<?php echo $res['prod_pic1']; ?>" alt="First slide" height="500" width="500">
                            <?php else: ?>
                        ...
                        <div class="carousel-item">
                            ...
                            <img class="d-block" src="../uploads/<?php echo $res['prod_pic2']; ?>" alt="Second slide" height="500" width="500">
                            <?php else: ?>
                            <img src="../uploads/default.png">
                            <?php endif; ?>
                            <div class="carousel-caption d-none d-md-block">
                        ...
                        <div class="carousel-item">
                            ...
                            <img class="d-block" src="../uploads/<?php echo $res['prod_pic3']; ?>" alt="Third slide" height="500" width="500">
                            <?php else: ?>
                            <img src="../uploads/default.png">
                            <?php endif; ?>
                            <div class="carousel-caption d-none d-md-block">
